# CYBEREYE — app nativa de iPhone (Xcode)

Tu propia app nativa estilo CYBEREYE / MINOS SIGINT: detección de
...
3. Abre `minos-scanner-ios/CyberEye.xcodeproj` (doble clic).
...
6. **Firma la app con tu Apple ID**:
   ...
   - En el proyecto: clic en "CyberEye" (raíz del navegador
...
- `CyberEye/CameraEngine.swift` — cámara, detección de movimiento,
  rastreo alfa-beta, autolock, memoria de objetivo, snap con Vision
- `CyberEye/ContentView.swift` — HUD, telemetría, MAG-TRACK, radar,
  reporte y panel avanzado
- `CyberEye/Managers.swift` — GPS opcional y giroscopio/brújula
